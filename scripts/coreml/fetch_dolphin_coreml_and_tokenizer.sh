...
TOKENIZER_VOCAB_FILE="$(jq -r ' .tokenizerVocabFile // "gpt2-vocab.json" ' "$MANIFEST_PATH")"
TOKENIZER_MERGES_FILE="$(jq -r ' .tokenizerMergesFile // "gpt2-merges.txt" ' "$MANIFEST_PATH")"
